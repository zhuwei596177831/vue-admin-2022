  ...
  <el-dialog title="导入表" :visible.sync="visible" width="1000px" top="5vh" append-to-body>
    ...
    <el-row>
      <el-table @row-click="clickRow" ref="table" :data="dbTableList" @selection-change="handleSelectionChange" height="260px">
        ...
        <el-table-column prop="databaseName" label="库名称" :show-overflow-tooltip="true"></el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 查询表数据
      getList() {
        this.queryParams.databaseName = this.databaseName;
      ...
      handleImportTable() {
        ...
        importTable({tables: tableNames, databaseName: this.databaseName}).then(res => {
